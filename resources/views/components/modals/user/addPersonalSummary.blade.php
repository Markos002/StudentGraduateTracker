        ...
        <form action="{{ route('student.add.personalSummary') }}" method="POST" class="space-y-4">
            ...
            <div class="text-black space-y-4">
                ...
                <textarea name="personal_summary" 
                          ...
                          class="w-full px-3 py-2 border border-black rounded-md focus:outline-none focus:ring-1 focus:ring-gray-700 focus:border-transparent resize-none">{{ old('personal_summary') }}</textarea>
                <p class="text-xs text-gray-500 mt-1">Write your summary here. Use at most 10 000 characters.</p>
            </div>
            
            <div class="flex gap-2">
                <button type="submit"
                  class="inline-flex items-center px-4 py-2 bg-[#D06139] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#e02a1d] focus:bg-[#e02a1d] active:bg-[#e02a1d] focus:outline-none focus:ring-2 focus:ring-[#e02a1d] focus:ring-offset-2 transition ease-in-out duration-150"
                >
                    Submit
                </button>

                <button type="button" onclick="closeModal('addPersonalSummary')" class="px-4 py-2 text-black">
                    Cancel
                </button>
            </div>
        </form>
