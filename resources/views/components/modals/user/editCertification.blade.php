<div id="editCert" class="modal-overlay hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-5 z-50">
    <div class=" bg-white rounded-lg w-full max-w-lg h-full overflow-y-auto max-h-[20rem]lg:h-full lg:max-h-[40rem] p-8">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-lg font-semibold text-black">Edit Certifications</h2>
            <button onclick="closeModal('editCert')" class="text-gray-600 hover:text-gray-900">
        ...
        <form method="POST" action="" class="gap-2 text-black text-sm">
            ...
            <div class="flex gap-2 mt-6">
                ...
                <button type="button" onclick="closeModal('editCert')" class="px-4 py-2 text-black">
                    Cancel
                </button>
            </div>
        </form>
