...
<div {{ $attributes->merge(['class' => 'relative w-full text-black bg-white rounded-md py-2 space-y-3 place-content-center']) }}>
    ...
    @if ($isPassword)
        <button type="button"
            ...
            class="absolute top-11 right-3 flex items-center text-gray-500 hover:text-gray-700 focus:outline-none">
            {{-- Open --}}
