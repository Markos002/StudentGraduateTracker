    ...
    <div class="max-w-6xl mx-auto bg-white shadow-xl rounded-lg">
        ...
        <div class="px-1 lg:px-14 py-8">
            ...
            <section class="mb-8 mx-10">
                ...
                <!-- Hidden element to store career data for JavaScript -->
                <div id="careerData" data-careers="{{ json_encode($careerHistory) }}" style="display:none;"></div>
                ...
                @if(isset($careerHistory) && count($careerHistory) > 0)
                    ...
                    <div class="text-gray-700 max-w-6xl p-6 border border-gray-700 rounded-lg my-2">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-semibold text-gray-800">{{ $career['position'] ?? ''}}</h3>
                            <div>
            ...
            <!-- Certifications -->
                <section class="mb-8 mx-10">
                    ...
                    <div id="certData" data-certifications="{{ json_encode($certifications ?? []) }}" style="display:none;"></div>
        ...
        <x-modals.user.editPersonalSummary :personalSummary="$personalSummary"/>
        <x-modals.user.addPersonalSummary/>
        <x-modals.user.addRole/>
        <x-modals.user.editRole/>

        <x-modals.user.addCertification/>
        <x-modals.user.editCertification/>
    </div>
