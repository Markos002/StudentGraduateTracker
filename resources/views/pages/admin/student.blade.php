        ...
        <div class="p-6 bg-white rounded-lg shadow-sm">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 gap-6">
                ...
                <div class="flex flex-wrap items-center justify-between gap-4">
                    {{-- Search --}}
                    <div class="flex-1 min-w-[200px] sm:w-auto">
                        <x-search.search 
                            id="searchInput"
                            placeholder="Search"
                            class="bg-[#EEEEEE] w-full"
                        />
                    </div>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        {{-- Add Student Button --}}
                        <x-buttons.secondary-button onclick="openModal('studentModal')" class="w-full sm:w-auto">
                            <x-slot:icon>
                        ...
                        {{-- Filters --}}
                        <form id="studentFilterForm" method="GET" action="{{ route('admin.student') }}" class="flex flex-wrap items-center gap-3 w-full sm:w-auto">
            ...
            <div class="overflow-x-auto">
                <x-table.table
                    :headers="['Student ID', 'Full Name', 'TOR Number', 'Course', 'Year Graduate']"
