        ...
        <div class="bg-[#FCF5F2]">
            <div class="relative overflow-hidden min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                ...
                <div class=" flex-1 py-5 z-10 max-w-2xl px-6 lg:max-w-7xl ">
                    ...
                    <main id="home" class="grid grid-col-2 w-full pt-28 lg:gap-8 md:pt-40 lg:items-center lg:justify-center lg:pt-0 lg:h-[40rem]">
            ...
            <!-- SYSTEM FEAUTES -->
            <div class="bg-white  place-content-center">
            ...
            <section class="relative">
                <div class="lg:flex">
                    ...
                    <div class="w-full py-20 lg:py-0 lg:w-3/4 bg-gray-300 relative flex items-center justify-center">
                        <div class="absolute left-0 top-0 w-1 h-full coral-line"></div>
                        <div class="absolute top-0 left-0 w-full h-1 coral-line"></div>
                            <div class="rounded-lg p-4 w-96 h-96 relative">
                                <img src="{{ asset('images/aboutus.png') }}" alt="laptop-track" class="w-[489px] h-[409px]">
                            </div>
                    </div>
            ...
            <section class="relative ">
                <div class="flex flex-col-reverse md:flex lg:flex-row ">
                    ...
                    <div class="w-full lg:w-3/4 py-32 lg:py-0 bg-gray-300 relative flex items-center justify-center">
                        <div class="absolute right-0 top-0 w-1 h-full coral-line"></div>
                        <div class="absolute top-0 right-0 w-full h-1 coral-line"></div>
                        <div class=" rounded-lg p-4 w-96 h-60 relative">
                            <div class="space-y-3">
                                <img src="{{ asset('images/howitworks.png') }}" alt="dashboard-track" class="w-[589px] h-[219px]">
                            </div>
                        </div>
                    </div>
                </div>
